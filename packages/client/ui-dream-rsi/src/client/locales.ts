...
export const zh = {
  ...
  'tree.select': '选择轮次',
  'progress.title': '最佳分数爬升',
  'progress.perRound': '单轮最佳',
  'progress.runningBest': '累计最佳',
  'progress.reference': 'AlphaEvolve 基线 {score}',
...
export const en = {
  ...
  'progress.title': 'Best score over rounds',
  'progress.perRound': 'Per-round best',
  'progress.runningBest': 'Running best',
  'progress.reference': 'AlphaEvolve baseline {score}',
